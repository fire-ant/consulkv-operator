...
# consul.io/consulkv-operator-bundle:$VERSION and consul.io/consulkv-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= chr1slavery/consulkv-operator
...
helm:	manifests	kustomize	helmify
	$(KUSTOMIZE) build config/default | $(HELMIFY) -crd-dir ${CHART_NAME}